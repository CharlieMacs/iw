<%@page import="com.xnx3.j2ee.func.Language"%>
  ...
  form.on('submit(formDemo)', function(data){
	...
	$.post("<%=basePath %>loginSubmit.do", d, function (result) {
		$.hideLoading();
       	...
       	if(obj.result == '1'){
       		layer.msg('<%=Language.show("user_loginSuccess", "登录成功") %>', {shade: 0.3});
...
function reloadCode(){
	...
	//这里必须加入随机数不然地址相同不重新加载
}


//检测浏览器，若不是Chrome浏览器，弹出推荐的浏览器使用提示
